...
use crate::surface_type::SurfaceType;
...
fn type_from_json(data: &Value, default: &SurfaceType) -> SurfaceType {
    return SurfaceType::from_string(data.as_str().get_or_insert(default.to_string()));
}
    ...
    pub fn default() -> Parameters {
        ...
        return Parameters {
            ...
            sphere_parameters: vec![
                SphereParameters {
                    sphere_type: SurfaceType::Reflexive,
                ...
                SphereParameters {
                    sphere_type: SurfaceType::Refractive,
                    generation_mode: SphereGenerationMode::Random,
                    sphere_count: 10,
                    min_radius: 1.,
                    max_radius: 5.,
