...
pub struct Parameters {
    ...
    pub observer_min_hor_angle: f64,
    pub observer_max_hor_angle: f64,
    pub observer_hor_angle_loop: bool,
    pub observer_min_ver_angle: f64,
    pub observer_max_ver_angle: f64,
    pub observer_ver_angle_loop: bool,
...
impl Parameters {
    pub fn default() -> Parameters {
        ...
        return Parameters {
            ...
            observer_min_hor_angle: 0.,
            observer_max_hor_angle: 2. * std::f64::consts::PI,
            observer_hor_angle_loop: true,
            observer_min_ver_angle: -std::f64::consts::PI / 2.,
            observer_max_ver_angle: std::f64::consts::PI / 2.,
            observer_ver_angle_loop: false,
